-- This is where all the additional functions are which are not strictly part of a programming environment like git
-- TODO refactor some of the core functionality: check if it can be split in core and language-addons or something
return {
